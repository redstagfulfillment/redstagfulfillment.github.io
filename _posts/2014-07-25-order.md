...
<tr>
    <th>print_copies</th>
    <td>
        <pre><code>{ "print_copies" : "one_per_order" }</code></pre>
        The "Print Copies" property. Values can be <code>one_per_order</code>, <code>one_per_shipment</code>, <code>one_per_package</code>, or <code>none</code>.
    </td>
</tr>
<tr>
    <th>print_target</th>
    <td>
        <pre><code>{ "print_target" : "4X6_LABEL" }</code></pre>
        The "Print Target" property. Values can be <code>4X6_LABEL</code>, <code>SMALL_LABEL</code>, or <code>LASER</code>.
    </td>
</tr>  
</tbody>
</table>
