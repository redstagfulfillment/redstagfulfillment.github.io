...
State | Description
----- | -----------
`new` | Order received and inventory reserved. <br/>Valid statuses: `new`, `partial_backorder`, `backordered`
`processing` | Shipments created and assigned to a picking batch. <br/>Valid statuses: `processing`, `partial_backorder`
