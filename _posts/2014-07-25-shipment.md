    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li>string '*' - Retrieve all properties excluding "shipping_address", "items", "packages" and "tracking_numbers".</li>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Status" property. Allowed values: new, picking, picked, packing, packed, loaded.
        </td>
    </tr>
    <tr>
        <th>total_weight</th>
