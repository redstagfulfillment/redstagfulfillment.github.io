...
the processed inventory and "Committing" the put-away inventory to the available inventory. Most of these steps happen automatically
...
<tbody>
    ...
    <tr>
        <td>1</td>
        <td>object - Delivery data. Allowed keys: "sender_name", "carrier_name", "expected_delivery", "merchant_ref", "sender_ref", "store_id".</td>
    </tr>
    <tr>
        <td>2</td>
        <td><ul>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            The "Status" property. Allowed: "new", "accepted", "processing", "processing_exception", "processed", "putting_away", "put_away", "complete", "canceled", "holded".
        </td>
    </tr>
    <tr>
