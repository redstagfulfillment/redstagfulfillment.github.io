...
<h1 id="import_create">
import.create
<code>(string $data, int $configId, string $fileType, null|object $options)</code>
</h1>
...
<tbody>
    ...
    <tr>
        <td>1</td>
        <td>int - The internal import ID.</td>
    </tr>
    <tr>
        <td>2</td>
    ...
    <tr>
        <td>3</td>
        <td>object - Import options. Allowed keys: "handle_duplicates", "send_email_on_complete", "email", "new_order_status".</td>
    </tr>
</tbody>
</table>
